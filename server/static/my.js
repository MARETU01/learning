function toPlay() {
    ...
    if (audio.paused) {
        audio.play();
        icon.src = "https://delphimonster-salturgent-3000.codio-box.uk/on.png";
    } else {
        audio.pause();
        icon.src = "https://delphimonster-salturgent-3000.codio-box.uk/off.png";
    }
}

let currentImageIndex = 1;
let images = [
    "https://delphimonster-salturgent-3000.codio-box.uk/hobby1.jpg",
    "https://delphimonster-salturgent-3000.codio-box.uk/hobby2.jpg",
    "https://delphimonster-salturgent-3000.codio-box.uk/hobby3.jpg",
    "https://delphimonster-salturgent-3000.codio-box.uk/hobby4.jpg"
];
